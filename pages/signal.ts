...
function findRelevantLevel(
  ema14: number[], ema70: number[], closes: number[],
  highs: number[], lows: number[], trend: 'bullish' | 'bearish'
...
export async function getSignalForSymbol(symbol: string): Promise<SignalData> {
