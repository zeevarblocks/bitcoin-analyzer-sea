...
export default function Rewards() {
  return (
    <div style={{ padding: '2rem', textAlign: 'center', background: '#fff', minHeight: '100vh' }}>
      <h1 style={{ fontSize: '2rem', marginBottom: '1rem' }}>Claim Your Binance Mystery Box</h1>
      ...
      <div style={{ marginTop: '3rem' }}>
        <Link href="/">
          <a style={{ color: '#0070f3', textDecoration: 'underline' }}>Back to Home</a>
        </Link>
      </div>
    </div>
  );
